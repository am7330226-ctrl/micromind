    ...
    >
      ...
      >
        <span
          ...
          style={{ color: '#a04100', fontSize: '24px' }}
        >
          leaderboard
        </span>
        <h3
      ...
      {/* #1 — The user */}
      <div
        className="leaderboard-item user-rank-card"
        style={{
          display: 'flex',
          alignItems: 'center',
          gap: '12px',
          padding: '12px',
          backgroundColor: 'rgba(99, 14, 212, 0.15)',
          borderRadius: '16px',
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div
            style={{
              width: '100%',
              height: '6px',
              backgroundColor: 'rgba(99, 14, 212, 0.2)',
              borderRadius: '6px',
              marginTop: '6px',
              overflow: 'hidden',
            }}
          ...
          >
            <div
              style={{
                ...
                height: '36px',
                borderRadius: '50%',
                backgroundColor: 'rgba(99, 14, 212, 0.1)',
                color: 'var(--text-primary)',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
      ...
      <div style={{ marginTop: 'auto', paddingTop: '20px' }}>
        ...
        >
          ...
          >
            Next reward at {NEXT_REWARD_XP} XP —{' '}
            {NEXT_REWARD_XP - userXp > 0
              ? `${NEXT_REWARD_XP - userXp} to go!`
              : 'Unlocked!'}
          </p>
          <p
            style={{
